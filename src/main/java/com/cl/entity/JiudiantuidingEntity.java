...
public class JiudiantuidingEntity<T> implements Serializable {
	private static final long serialVersionUID = 1L;


	public JiudiantuidingEntity() {
		
	}
	
	public JiudiantuidingEntity(T t) {
		try {
	 ...
	 * 设置：一晚价格
	 */
	public void setYiwanjiage(String yiwanjiage) {
		this.yiwanjiage = yiwanjiage;
	}
	/**
	 * 获取：一晚价格
	 */
	public String getYiwanjiage() {
		return yiwanjiage;
	}
	/**
	 * 设置：退订时间
