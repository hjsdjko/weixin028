...
<view class="content">
	<view :style='{"width":"100%","padding":"0 0 0 0","position":"relative","background":"#ffffff","height":"100%"}'>
		<form :style='{"width":"100%","padding":"24rpx 24rpx 24rpx 24rpx","background":"#ffffff","display":"block","height":"auto"}' class="app-update-pv">
			...
			<view :style='{"padding":"4rpx 0 4rpx 0","margin":"0 0 24rpx 0","borderColor":"#eeeeee","alignItems":"center","borderWidth":"2rpx 2rpx 2rpx 2rpx","background":"#fdfbdc","display":"flex","width":"100%","borderStyle":"solid","height":"auto"}' class="">
				<view :style='{"width":"160rpx","padding":"0 20rpx 0 0","lineHeight":"80rpx","fontSize":"28rpx","color":"#333333","textAlign":"right"}' class="title">人均消费</view>
				<input :style='{"border":"0px solid #eeeeee","padding":"0px 24rpx 0px 24rpx","margin":"0 0 0 0","color":"#666666","borderRadius":"8rpx","flex":"1","background":"#ffffff00","fontSize":"28rpx","lineHeight":"80rpx","height":"80rpx"}' :disabled="ro.renjunxiaofei" v-model="ruleForm.renjunxiaofei" placeholder="人均消费"></input>
			</view>
			<view :style='{"padding":"4rpx 0 4rpx 0","margin":"0 0 24rpx 0","borderColor":"#eeeeee","alignItems":"center","borderWidth":"2rpx 2rpx 2rpx 2rpx","background":"#fdfbdc","display":"flex","width":"100%","borderStyle":"solid","height":"auto"}' class="">
				<view :style='{"width":"160rpx","padding":"0 20rpx 0 0","lineHeight":"80rpx","fontSize":"28rpx","color":"#333333","textAlign":"right"}' class="title">打卡地点</view>
				<input :style='{"border":"0px solid #eeeeee","padding":"0px 24rpx 0px 24rpx","margin":"0 0 0 0","color":"#666666","borderRadius":"8rpx","flex":"1","background":"#ffffff00","fontSize":"28rpx","lineHeight":"80rpx","height":"80rpx"}' :disabled="ro.dakadidian" v-model="ruleForm.dakadidian" placeholder="打卡地点"></input>
			</view>
			...
			<view :style='{"padding":"12rpx 0 12rpx 0","margin":"0 0 24rpx 0","borderColor":"#eeeeee","borderWidth":"0 0 0px 0","width":"100%","borderStyle":"solid","height":"auto"}' class="">
				<view :style='{"width":"100%","lineHeight":"80rpx","fontSize":"28rpx","color":"#333333","fontWeight":"500"}' class="title">美食介绍</view>
                <xia-editor ref="editor" :style='{"minHeight":"300rpx","border":"2rpx solid #eeeeee","padding":"20rpx","color":"#666666","background":"#fdfbdc","width":"100%","height":"auto"}' v-model="ruleForm.meishijieshao" placeholder="美食介绍" @editorChange="meishijieshaoChange"></xia-editor>
			</view>
	...
	export default {
		...
		async onLoad(options) {
			...
			if (options.id) {
				...
				// 获取信息
				res = await this.$api.info(`tesemeishi`, this.ruleForm.id);
		...
		methods: {
            meishijieshaoChange(e) {
                this.ruleForm.meishijieshao = e
            },
			styleChange() {
				this.$nextTick(()=>{
...
//跨表计算判断
				...
				if((!this.ruleForm.tuijianzhishu)){
					this.$utils.msg(`推荐指数不能为空`);
					return
				}
				if((!this.ruleForm.dakadidian)){
					this.$utils.msg(`打卡地点不能为空`);
					return
				}
				//更新跨表属性
			       var crossuserid;
				...
				if(crossrefid && crossuserid) {
					...
					let res = await this.$api.list(`tesemeishi`, params);
                ...
                //跨表计算
						if(this.ruleForm.id){
							await this.$api.update(`tesemeishi`, this.ruleForm);
						}else{
							await this.$api.add(`tesemeishi`, this.ruleForm);
						}
